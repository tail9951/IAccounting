...
public class AccountController {
    ...
    public void insert_acc(String acc_name,String currency,String acc_amount) {
        ContentValues values = new ContentValues();
        values.put(ACC_NAME, acc_name);
        values.put(ACC_NAME, currency);
        values.put(ACC_NAME, acc_amount);
    ...
    public void display(ListView lv){
        ...
        SimpleAdapter SA = new SimpleAdapter(mycontext,items,
                android.R.layout.simple_expandable_list_item_2,new String[]{"ID","NAME"},
